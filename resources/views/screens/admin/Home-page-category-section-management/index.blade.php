                                        ...
                                        @foreach ($sections as $section)
                                            <tr class="odd">
                                                <td class="dtr-control sorting_1" tabindex="0">
                                                   <img src="{{ $section->getFirstMediaUrl('category-section-image') ? $section->getFirstMediaUrl('category-section-image') : asset('images/Untitled-2.png') }}" alt="" height="100" width="100"> </td>
                                                <td class="dtr-control sorting_1" tabindex="0">
                                                ...
                                                <td class="d-flex gap-20">
                                                    <a href="{{ route('admin.home.page.category.section.edit', $section->slug) }}"
