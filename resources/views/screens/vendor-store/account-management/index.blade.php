                        ...
                        <div class="upcoming-course-area">
                            ...
                            <div class="profile-area-main">
                                <div class="profile-area-main-left">
                                    <form action="{{ route('vendor.account.update') }}" method="POST" id="profile-form">
                                        @csrf
                                        <div class="profile-area">
                                            <h3 class="profile-info-title m-0">Account Information</h3>
                                            ...
                                            <div class="profile-field-area">
                                                <div class="row justify-content-between align-items-center">
                                                    ...
                                                    <div class="col-12 col-lg-9 col-xl-8">
                                                        <input class="profile-fields"
                                                            value="{{ auth()?->user()?->business_name }}" type="text"
                                                            name="store_name" id="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-field-area">
                                                <div class="row justify-content-between align-items-center">
                                                    ...
                                                    <div class="col-12 col-lg-9 col-xl-8">
                                                        <input class="profile-fields"
                                                            value="{{ auth()?->user()?->business_address }}" type="text"
                                                            name="business_address" id="autocomplete">
                                ...
                                <div class="profile-area-main-right">
                                    <form action="{{ route('vendor.account.update.image') }}" method="POST"
                                    ...
                                    <div class="profile-img-area text-center">
                                        ...
                                        <form action="{{ route('vendor.account.update.password') }}" method="POST"
                                            id="password-form">
                                            @csrf
