                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 mb-5">
                            <div class="store-card">
                                <div class="card-image">
                                    <img src="{{ asset($store['img']) }}" alt="{{ $store['store_name'] }}" class="store-img">
                                </div>
                                <div class="store-details">
                                    <h5 class="store-title">{{ $store['store_name'] }}</h5>
                                    <p class="store-description">{{ $store['description'] }}</p>
                                    <a href="{{ route('shop') }}" class="btn visit-btn">Visit Store</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
