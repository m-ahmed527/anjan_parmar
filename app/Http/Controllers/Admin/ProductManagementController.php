...
class ProductManagementController extends Controller
{
    public function index(): View
    {
        ...
        return view('screens.admin.product-management.index', compact('products'));
    }
    ...
    public function create(): View
    {
        ...
        $brands = Brand::all();
        return view('screens.admin.product-management.create', compact('categories', 'attributes', 'brands'));
    }
